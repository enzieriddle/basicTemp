...
function basictemp_customizer($wp_customize) {
    // 1. Copyright section
        ...
        array(
            ...
            $wp_customize -> add_control(
                ...
                array(
                    ...
                    'description' => 'Type copyright here',
        ...
        array(
            ...
            $wp_customize -> add_control(
                ...
                array(
                    ...
                    'description' => 'Type your button text here.',
                    'section' => 'sec_hero',
                    'type' => 'text'
                )
            );
            ...
            $wp_customize -> add_control(
                ...
                array(
                    ...
                    'description' => 'Type your button link here.',
                    'section' => 'sec_hero',
                    'type' => 'url'
                )
            );
            ...
            $wp_customize -> add_control(
                ...
                array(
                    'label' => 'Hero height',
                    'description' => 'Type your hero heighthere.',
                    'section' => 'sec_hero',
                    'type' => 'number'
                )
            );
...
add_action('customize_register', 'basictemp_customizer');