        ...
        <div id="content" class="site-content">
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                    <?php 
                        $hero_title = get_theme_mod('set_hero_title', 'Title Here');
                        $hero_subtitle = get_theme_mod('set_hero_subtitle', 'Subtitle Here');
                        ...
                        <div class="container">
                            <?php 
                                ...
                                $args = array(
                                    ...
                                    'category__in' => explode(",", $categories_include),
                                    'category__not_in' => explode(",", $categories_exclude)
                                );
